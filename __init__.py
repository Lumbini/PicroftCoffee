...
class MachineControlSkill(MycroftSkill):
    ...
    def initialize_mqtt(self):
        ...
        self.mqtt_client.tls_set(self.ca_path, certfile=self.cert_path, keyfile=self.key_path, cert_reqs=ssl.OPENSSL_VERSION, tls_version=ssl.PROTOCOL_TLSv1_2, ciphers=None)
